...
public interface SaleOrderCreateService {
   ...
   *     team.
   * @param taxNumber Tax number of the order.
   * @param internalNote Note used internally, will not be displayed in the PDF.
   * @param fiscalPosition fiscal position of the order.
